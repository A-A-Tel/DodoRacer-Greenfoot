...
public class Mauritius extends World {
    ...
    private Actor charToActor(char c) {
        ...
        switch (c) {
            ...
            case DODO_N:
                newDodo = new MyDodo();
                newDodo.setDirection(Direction.NORTH);
                return newDodo;
            case DODO_S:
                newDodo = new MyDodo();
                newDodo.setDirection(Direction.SOUTH);
                return newDodo;
            case DODO_E:
                newDodo = new MyDodo();
                newDodo.setDirection(Direction.EAST);
                return newDodo;
            case DODO_W:
                newDodo = new MyDodo();
                newDodo.setDirection(Direction.WEST);
                return newDodo;
            default:
                return null;
        }
